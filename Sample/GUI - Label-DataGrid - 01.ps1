...
$DataGridView1.width             = 170
$DataGridView1.height            = 250
$DataGridView1Data = @(@("Print1"),@("Print2"))
$DataGridView1.ColumnCount = 1
$DataGridView1.ColumnHeadersVisible = $true
$DataGridView1.Columns[0].Name = "Printers"
foreach ($row in $DataGridView1Data){
          $DataGridView1.Rows.Add($row)
      }
$DataGridView1.Anchor            = 'top,right,bottom,left'
$DataGridView1.location          = New-Object System.Drawing.Point(50,79)

$SelectPrinters.controls.AddRange(@($Use1,$Default1,$Use2,$Default2,$Cencel,$OK,$Printer2,$Printer1,$DataGridView1))

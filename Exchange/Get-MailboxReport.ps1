...
if ($filename) {
    ...
    $reportfile = "C:\Temp\$date-MailboxReport-$random.csv"
}
...
foreach ($mb in $mailboxes) {
    ...
    $userObj | Add-Member NoteProperty -Name "Retention Policy" -Value $mb.Retentionpolicy
    $userObj | Add-Member NoteProperty -Name "Use Database Quota Defaults" -Value $mb.UseDatabaseQuotaDefaults
    $userObj | Add-Member NoteProperty -Name "Litigation Hold" -Value $LitigationHold.LitigationHoldEnabled

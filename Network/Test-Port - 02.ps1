...
Foreach ($HostName in $HostList) {
    Write-Host "`n`tPlease Wait - Testing $HostName" -Fore Yellow
    #Test-Port -computer $HostName -port $HostPorts $HostPortType
    Test-Port -computer $HostName -port 1812, 1645, 1813, 1646 -UDP
}
